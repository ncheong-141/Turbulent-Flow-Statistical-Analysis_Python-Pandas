...
"""
TO START PROGRAM YOU NEED TO TYPE INIT = 0; IN THE CONSOLE 
(This is to avoid constantly reloading data when writing)
"""

# Import data from .mat files and comments with understanding of data 
if (init == 0) : 
